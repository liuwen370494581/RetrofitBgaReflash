package star.liuwen.com.endexcelcreator;
...
import star.liuwen.com.endexcelcreator.zzexcelcreator.ZzExcelCreator;
import star.liuwen.com.endexcelcreator.zzexcelcreator.ZzFormatCreator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void assignViews() {
        ...
        btnAddNumber.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final String fileName = etFileName.getText().toString().trim();
        ...
        btnAddString.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final String fileName = etFileName.getText().toString().trim();
